...
{
	public class GridActionList2 : DesignerActionList
	{
		private DesignerActionUIService designerActionSvc;
		private ExpandGrid table;
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		public GridActionList2(IComponent component) : base(component)
		{
			this.designerActionSvc = null;
			this.table = (component as ExpandGrid);
