...
{
	public class CrossingDealConfirmMessageFormat
	{
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		public string Pack(int firm, long orderNumberBuy, string orderEntryDataBuy, long orderNumberSell, string orderEntryDataSell, long volume, decimal price, int confirmNumber)
		{
			this.firm = firm;
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		public CrossingDealConfirmMessageFormat()
		{
		}
	}
}
