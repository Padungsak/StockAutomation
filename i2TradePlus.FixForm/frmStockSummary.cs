...
namespace i2TradePlus.FixForm
{
	public class frmStockSummary : ClientBaseForm, IRealtimeMessage
	{
		...
		private void InitializeComponent()
		{
			...
			this.tstxtSaleByTimeSearchTimeHour.ToolTipText = "{ เน€เธงเธฅเธฒ เธ—เธตเนเธ•เนเธญเธเธเธฒเธฃเธเนเธเธซเธฒ เธซเธเนเธงเธขเน€เธเนเธ เธเธก.}";
			...
			this.tstxtSaleByTimeSearchTimeMinute.ToolTipText = "{ เน€เธงเธฅเธฒ เธ—เธตเนเธ•เนเธญเธเธเธฒเธฃเธเนเธเธซเธฒ เธซเธเนเธงเธขเน€เธเนเธ เธเธฒเธ—เธต}";
