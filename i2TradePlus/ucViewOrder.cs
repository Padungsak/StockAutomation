			...
			else
			{
				try
				{
					...
					if (orderInfoClient.Account.Trim() == ApplicationInfo.AccInfo.CurrentAccount)
					{
						...
						if (ApplicationInfo.SupportFreewill && this.frmConfirm != null && orderInfoClient.OriginalMessageType == "2C")
						{
		...
		private void intzaStopOrder_TableMouseDoubleClick(object sender, STIControl.SortTableGrid.TableMouseEventArgs e)
		{
			try
			{
				if (!this._loadStopOrderFLS && e.Column.Name == "status")
				{
					...
					if (a == "F")
					{
						this.lbFLS.Text = "เธเธเธเนเธญเธเธดเธ”เธเธฅเธฒเธ”";
				...
				if (e.Error == null)
				{
					using (DataSet dataSet = new DataSet())
					{
						if (!string.IsNullOrEmpty(e.Result))
						{
							...
							{
								string text = "เนเธกเนเธเธเธฃเธฒเธขเธเธฒเธฃเธ—เธตเนเธเนเธเธซเธฒ!";
								...
								this.lbFLS.Text = "เธฃเธฒเธขเธเธฒเธฃเธเธฑเธเธเธนเนเธ—เธตเนเน€เธเธดเธ”เธซเธฅเธฑเธเธเธฒเธเธเธฒเธฃเธชเนเธเธเธณเธชเธฑเนเธ";
