...
namespace i2TradePlus
{
	public class ucOrderStat : UserControl
	{
		...
		private void bgwPortStat_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
		{
			try
			{
				...
				foreach (KeyValuePair<string, int> current in dictionary)
				{
					...
					this.tableStockList.Records(num).Fields("rowId").FontColor = Color.Yellow;
					this.tableStockList.Records(num).Fields("stock").FontColor = Color.Yellow;
					this.tableStockList.Records(num).Fields("deals").FontColor = Color.Yellow;
					num++;
				}
				dictionary.Clear();
				dictionary = null;
		...
		private void bgwPortStatByStock_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
		{
			try
			{
				...
				foreach (KeyValuePair<decimal, ucOrderStat.OrderRecord> current in dictionary)
				{
					...
					this.tableDetail.Records(num15).Fields("buyVol").FontColor = Color.Yellow;
					this.tableDetail.Records(num15).Fields("buyMatchVol").FontColor = Color.Cyan;
					this.tableDetail.Records(num15).Fields("sellDeal").FontColor = Color.LightGray;
					this.tableDetail.Records(num15).Fields("sellVol").FontColor = Color.Yellow;
					this.tableDetail.Records(num15).Fields("sellMatchVol").FontColor = Color.Magenta;
		...
		private void frmViewOrderHistory_IDoHeaderChanged()
		{
			try
			{
				this.tableDetail.GetColumn("buyDeal").BackColor = Color.Cyan;
				this.tableDetail.GetColumn("buyMatchVol").BackColor = Color.Cyan;
				this.tableDetail.GetColumn("buyVol").BackColor = Color.Cyan;
				...
				this.tableDetail.GetColumn("sellMatchVol").BackColor = Color.Magenta;
				this.tableDetail.GetColumn("sellVol").BackColor = Color.Magenta;
				this.tableDetail.GetColumn("sellDeal").BackColor = Color.Magenta;
				...
				this.intzaSum.GetColumn("buy").BackColor = Color.Cyan;
				this.intzaSum.GetColumn("sell").BackColor = Color.Magenta;
		...
		private void InitializeComponent()
		{
			...
			this.intzaSum.ScrollChennelColor = Color.Gray;
			...
			this.tableStockList.ScrollChennelColor = Color.Gray;
			...
			this.tableDetail.ScrollChennelColor = Color.LightGray;
